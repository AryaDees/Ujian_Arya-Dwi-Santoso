...
if (mysqli_ping($conn)) {
  echo "Koneksi masih aktif";
} else {
  echo "Koneksi tidak aktif";
}
$nim = "";
$nama = "";
$alamat = "";
...
if ($op == 'delete') {
    $id = $_GET['id'];
    $sql1 = "delete from dataujian where id = '$id'";
...
if ($op == 'edit') {
    $id = $_GET['id'];
    $sql1 = "select * from dataujian where id = '$id'";
    $q1 = mysqli_query($conn, $sql1);
...
if (isset($_POST['simpan'])) { //untuk create
    ...
    if ($nim && $nama && $alamat && $jurusan && $fakultas) {
        if ($op == 'edit') { //untuk update
            $sql1 = "update dataujian set nim = '$nim',nama = '$nama',alamat = '$alamat',jurusan = '$jurusan', fakultas = '$fakultas' where id = '$id'";
            $q1 = mysqli_query($conn, $sql1);
            if ($q1) {
            ...
            $sql1 = "insert into dataujian(nim,nama,alamat,jurusan,fakultas) values ('$nim','$nama','$alamat','$jurusan','$fakultas')";
            $q1 = mysqli_query($conn, $sql1);
            if ($q1) {
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table class="table">
                        ...
                        <tbody>
                            <?php
                                $sql2 = "select * from dataujian order by nim desc";
